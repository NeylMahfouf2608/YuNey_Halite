...
// Les valeurs viennent de la génétique
int hlt::constants::GENE_DROPOFF_WEALTH = 14397;
int hlt::constants::GENE_DROPOFF_DIST = 15;
int hlt::constants::GENE_SPAWN_WEALTH_RATIO = 5222;
int hlt::constants::GENE_KAMIKAZE_PROFIT = 599;
double hlt::constants::GENE_ENDGAME_TURN_OFFSET = 1.1;
int hlt::constants::GENE_STOP_SPAWN_TURN = 109;
int hlt::constants::GENE_KAMIKAZE_MIN_DANGER = 466;
int hlt::constants::GENE_MINING_THRESHOLD_MIN = 31;
int hlt::constants::GENE_MINING_THRESHOLD_MAX = 65;
double hlt::constants::GENE_INSPIRATION_BONUS = 3.9;
float hlt::constants::GENE_SPAWN_MAX_SHIPS_RATIO = 39;
int hlt::constants::GENE_ECO_ABANDON_PENALTY = -5;
int hlt::constants::GENE_RETURN_THRESHOLD = 851;
int hlt::constants::GENE_CONGESTION_PENALTY = 2;
int hlt::constants::GENE_DROPOFF_MIN_SHIPS = 14;
